      ...
      <div class="price-count-wrap">
        <div class="price-count">
          <ul>
            ...
            <li>
              <span>Shipping:</span>
              <span><span class="price-count-hint">+</span>{{shipping | currency('￥')}}</span>
            </li>
            <li>
              <span>Discount:</span>
              <span><span class="price-count-hint">-</span>{{discount | currency('￥')}}</span>
            </li>
            <li>
              <span>Tax:</span>
              <span><span class="price-count-hint">+</span>{{tax | currency('￥')}}</span>
            </li>
  ...
  export default{
      data() {
          ...
          methods:{
            ...
            payMent() {
              var addressId = this.$route.query.addressId;   //获取路由中的变量
