<template>
  ...
  <div class="navbar">
    ...
    <div class="navbar-right-container" >
      <div class="navbar-menu-container">
        ...
        <a href="javascript:void(0)" class="navbar-link" @click='loginMoalFlag=true' v-if="!nickName">Login</a>
        <a href="javascript:void(0)" class="navbar-link" @click="logOut" v-show="nickName">Logout</a>
        <div class="navbar-cart-container">
          <span class="navbar-cart-count" v-if="cartCount >0"></span>
   ...
   <div class="md-modal modal-msg md-modal-transition " v-bind:class="{'md-show':loginMoalFlag}">
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">Login in</div>
              <button class="md-close" @click="loginMoalFlag=false">Close</button>
            </div>
  ...
  <div class="md-overlay" v-if="loginMoalFlag" @click="loginMoalFlag=false" ></div>
</header>
</template>
